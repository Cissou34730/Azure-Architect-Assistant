"""Archived: Asyncio executor utilities (unused in current ingestion pipeline).

This module previously provided helpers to manage asyncio event loops from
worker threads, but the current ingestion architecture no longer depends on
these utilities. Keeping here for reference.

Contents mirrored from the former location:
