      ...
      <div className="flex items-center justify-between">
        ...
        <StatusBadge
          variant={
            isPaused
              ? "paused"
              : (job.status as "running" | "completed" | "failed")
          }
        >
                ...
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
                    isComplete
                      ...
                      : isActive
                        ? `${PHASE_COLORS[phase]} text-white animate-pulse`
      ...
      {hasMetrics && (
        <div className="space-y-3 pt-4 border-t">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            ...
            {metrics.chunks_embedded !== undefined &&
              metrics.chunks_queued !== undefined && (
                <MetricCard
            ...
            {metrics.chunks_failed !== undefined &&
              metrics.chunks_failed > 0 && (
                <MetricCard
                  label="Failed Chunks"
