...
export function TraceabilityView({ projectState }: { readonly projectState: ProjectState }) {
...
export function CandidateArchitectureView({ projectState }: { readonly projectState: ProjectState }) {
...
export function IterationEventsView({ projectState }: { readonly projectState: ProjectState }) {
...
export function McpQueriesView({ projectState }: { readonly projectState: ProjectState }) {
