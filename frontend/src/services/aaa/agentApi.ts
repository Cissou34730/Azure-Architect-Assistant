...
export const agentApi = {
  ...
  async chatWithProject(
    ...
    return fetchWithErrorHandling<AgentResponse & { project_state?: ProjectState }>(
  ...
  async getProjectHistory(projectId: string): Promise<AgentConversationHistoryResponse> {
