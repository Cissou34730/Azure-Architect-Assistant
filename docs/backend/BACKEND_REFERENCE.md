...
- `agents_system/services/waf_findings_worker.py` — Phase 8 validation worker helper; packages actionable WAF evaluator gaps into remediation-focused findings plus linked checklist deltas before a future validate-stage runtime wires the bundle into pending changes.
