...
def migrate_add_phase_columns():
    ...
    try:
        ...
        if needs_migration:
            ...
            for job_id, status in jobs:
                ...
                if status == 'completed':
                    ...
                    phase_progress = {
                        'crawling': {'status': 'completed', 'progress': 100, 'items_processed': 0, 'items_total': 0},
                        'cleaning': {'status': 'completed', 'progress': 100, 'items_processed': 0, 'items_total': 0},
                        'chunking': {'status': 'completed', 'progress': 100, 'items_processed': 0, 'items_total': 0},
                        'embedding': {'status': 'completed', 'progress': 100, 'items_processed': 0, 'items_total': 0},
                        'indexing': {'status': 'completed', 'progress': 100, 'items_processed': 0, 'items_total': 0}
                    }
                elif status == 'failed':
                    current_phase = 'crawling'
                    # Mark crawling as failed
                    phase_progress = {
                        'crawling': {'status': 'failed', 'progress': 0, 'items_processed': 0, 'items_total': 0, 'error': 'Migration: Unknown error'},
                        'cleaning': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0},
                        'chunking': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0},
                        'embedding': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0},
                        'indexing': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0}
                    }
                    ...
                    phase_progress = {
                        'crawling': {'status': phase_status, 'progress': 0, 'items_processed': 0, 'items_total': 0},
                        'cleaning': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0},
                        'chunking': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0},
                        'embedding': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0},
                        'indexing': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0}
                    ...
                    current_phase = 'crawling'
                    phase_progress = {
                        'crawling': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0},
                        'cleaning': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0},
                        'chunking': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0},
                        'embedding': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0},
                        'indexing': {'status': 'pending', 'progress': 0, 'items_processed': 0, 'items_total': 0}
        ...
        for col in columns:
            ...
            print(f"  {name:20} {col_type:15} {'NOT NULL' if not_null else ''} {f'DEFAULT {default_val}' if default_val else ''}")
