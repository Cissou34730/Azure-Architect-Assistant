...
class SyntaxValidator:
        ...
        for i, char in enumerate(source_code):
            if char in brackets.keys():
                ...
                if brackets[opening] != char:
                    errors.append(f"Mismatched brackets: '{opening}' closed with '{char}'")
                    break
    ...
    async def validate_plantuml_syntax(self, source_code: str, plantuml_jar_path: str) -> ValidationResult:
        ...
        """
        logger.warning("PlantUML syntax validation deferred - using remote rendering in Phase 5")
