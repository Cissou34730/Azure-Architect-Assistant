...
class ValidationFindingInput(BaseModel):
    ...
    id: str | None = Field(default=None, description="Stable finding id when pre-generated by a worker")
    ...
    impacted_components: list[str] = Field(
        ...
        description="Components impacted by this finding",
    )
    ...
    waf_checklist_item_id: str | None = Field(
        default=None,
        description="Stable WAF checklist item id for linking findings to evaluation deltas",
    )
            ...
            items.append(
                {
                    ...
                    "impactedComponents": [component.strip() for component in f.impacted_components if component.strip()],
                    "wafPillar": f.waf_pillar,
                    "wafTopic": f.waf_topic,
                    "wafChecklistItemId": f.waf_checklist_item_id,
