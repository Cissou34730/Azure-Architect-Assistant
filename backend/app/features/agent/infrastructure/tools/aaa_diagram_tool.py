...
class AAACreateDiagramSetTool(BaseTool):
    ...
    async def _generate_and_persist(self, args: AAACreateDiagramSetInput) -> str:
        ...
        from app.features.diagrams.application.ambiguity_detector import (  # noqa: PLC0415
            AmbiguityDetector,
        )
        from app.features.diagrams.application.database import get_diagram_session  # noqa: PLC0415
        from app.features.diagrams.application.diagram_generator import (  # noqa: PLC0415
            DiagramGenerator,
        )
        from app.features.diagrams.application.llm_client import DiagramLLMClient  # noqa: PLC0415
        from app.features.diagrams.infrastructure.models import (  # noqa: PLC0415
            AmbiguityReport,
            Diagram,
            DiagramSet,
            DiagramType,
