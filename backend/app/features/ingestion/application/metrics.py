...
from app.features.ingestion.application.status_query_service import KBPersistedStatus
...
def apply_counter_overrides(metrics: IngestionMetrics, counters: JobCounters) -> None:
...
def derive_job_status(latest_job_state: Any, kb_status: KBPersistedStatus) -> JobStatus:
